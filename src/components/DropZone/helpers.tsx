...
import { Maybe, mergeClassNames } from '../../utils';
import { Div } from '../Div';
import {
...
export const getErrorDescription = (file: DropZoneFileType | ExternalFile): string => Maybe(getError(file))
  .do((inwards: DropZoneError): string | undefined => inwards.message)
  .withDefault('Неизвестная ошибка')
  .getValue();
