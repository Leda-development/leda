...
export const AutoComplete = React.forwardRef((props: AutoCompleteProps, ref): React.ReactElement | null => {
  const {
    className,
    data,
    filterRule,
  ...
  const { isValid, validateCurrent, InvalidMessage } = useValidation(props, { value: stateValue });
