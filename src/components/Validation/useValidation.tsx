...
import { ValidationProps, ValidationResult, ValidationState } from './types';

export const useValidation = <P extends ValidationProps, S extends ValidationState>(props: P, state: S): ValidationResult => {
  const {
    form,
    name,
    isRequired = false,
